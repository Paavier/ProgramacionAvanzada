...
public class TestRunnerPr41Ej2 {
    ...
    private static final java.util.regex.Pattern float_pattern = java.util.regex.Pattern.compile("[+-]?(([0-9]+[.][0-9]+([eE][+-]?[0-9]+)?)|([0-9]+[eE][+-]?[0-9]+))");
    ...
    private static class SysOutCapture {
        private final SysOutErrCapture systemout;
        private final SysOutErrCapture systemerr;
            ...
            public String sysOutRelease() throws RuntimeException {
                ...
                if (estado != 1) {
                    ...
                    try {
                        ...
                        if (baos != null) {
                            baos.flush();
                            result = baos.toString(); //java.nio.charset.StandardCharsets.ISO_8859_1);
                        }
                    } catch (Throwable e) {
